...
function PrevEdit({publicacionId}) {
    ...
    const editarPublicaciones = () => {
        navigate("/Editar/"+encodeURIComponent(publicacionId));
    }
        ...
        <div className="main__container modo-edicion">
                ...
                <div className="Card">
                    ...
                    <div className="action__buttons">
                        <button className="btn__edit" onClick={editarPublicaciones}>Editar Publicacion</button>
